                ...
                <div class="col-md-12 mb-3 mt-2">
                    <div class="card">
                        <div class="card-header bg-info">
                            <span class="text-light"><i class="fa-solid fa-toolbox"></i> ตารางายการซ่อมที่กำลังซ่อม</span>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table table-hover dt-responsive nowrap data-table" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        WHERE em.employee_id = $emp_id AND re.repair_status = 3";
                                            $stmt = $conn->query($sql);
                                        }
