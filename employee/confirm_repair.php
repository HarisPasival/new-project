        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 mt-2">
                    <h4>รายการซ่อมที่ยืนยันการซ่อมแล้ว</h4>
                ...
                <div class="col-md-12 mb-3 mt-2">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <span class="text-light"><i class="fa-solid fa-toolbox"></i> ตารางายการซ่อมที่ยืนยันการซ่อมแล้ว</span>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table table-hover dt-responsive nowrap data-table" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        WHERE em.employee_id = $emp_id AND re.repair_status = 2";
                                            $stmt = $conn->query($sql);
                                        }
