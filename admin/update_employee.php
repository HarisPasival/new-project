                        ...
                        <div class="card-body">
                            ...
                            <form action="crud.php" method="POST" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="username_emp" value="<?= $result['username_emp'] ?>" class="form-control" />
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <button type="submit" name="update_emp" class="btn btn-warning">แก้ไขข้อมูล</button>
